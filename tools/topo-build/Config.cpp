...
void printUsage(const char* argv0) {
    std::cerr << "Usage: " << argv0 << " [<cpp-sources...> --topo <root.topo> -o <output>] [options]\n"
              ...
              << "\nBy default ([build].check = \"auto\"), topo-check runs exactly when an enabled\n"
              << "optimization consumes .topo declarations (parallel / loop-parallel / lifetime /\n"
              << "forced pipeline); plain builds stay unchecked.\n"
              << "\nExamples:\n"
